const ap1PracticeExamMCQPoolOne = [

    {
        ...
        jpegDiagram: `<img src="./images/mcq-diagram-1.jpg" alt="MCQ Diagram 1" style="display:block; margin:auto; max-width:300px; height:auto;" />`,
...

    {
        ...
        jpegDiagram: `<img src="./images/mcq-diagram-2.jpg" alt="MCQ Diagram 2" style="display:block; margin:auto; max-width:300px; height:auto;" />`,
        ...
        choices: [
            {
                ...
                jpegDiagram: `<img src="./images/mcq-diagram-3.jpg" alt="MCQ Diagram 3" style="display:block; margin:auto; max-width:300px; height:auto;" />`
            },
            {
                text: "Normal force at Point 1 (bottom) is longest; Points 2 and 4 (sides) are equal and medium; Point 3 (top) is shortest.",
                jpegDiagram: `<img src="./images/mcq-diagram-4.jpg" alt="MCQ Diagram 4" style="display:block; margin:auto; max-width:300px; height:auto;" />`
            },
            {
                text: "Normal force at Point 3 (top) is longest; Points 2 and 4 are equal; Point 1 (bottom) is shortest.",
                jpegDiagram: `<img src="./images/mcq-diagram-5.jpg" alt="MCQ Diagram 5" style="display:block; margin:auto; max-width:300px; height:auto;" />`
            },
            {
        ...
        choices: [
            {
                ...
                jpegDiagram: `<img src="./images/mcq-diagram-10.jpg" alt="MCQ Diagram 10" style="display:block; margin:auto; max-width:300px; height:auto;" />`
            },
            {
                ...
                jpegDiagram: `<img src="./images/mcq-diagram-11.jpg" alt="MCQ Diagram 11" style="display:block; margin:auto; max-width:300px; height:auto;" />`
            },
            {
                text: "Cosine curve identical in shape to the position graph (same phase), scaled up in amplitude.",
                jpegDiagram: `<img src="./images/mcq-diagram-12.jpg" alt="MCQ Diagram 12" style="display:block; margin:auto; max-width:300px; height:auto;" />`
            },
            {
                text: "Negative cosine curve: starts at −v_max at t = 0.",
                jpegDiagram: `<img src="./images/mcq-diagram-13.jpg" alt="MCQ Diagram 13" style="display:block; margin:auto; max-width:300px; height:auto;" />`
            }
        ],
